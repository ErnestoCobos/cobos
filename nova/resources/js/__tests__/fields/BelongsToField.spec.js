...
describe('BelongsToField', () => {
    ...
    test('when creating via a related resource it selects the related resource on mount if the field is searchable',
        async () => {
            const wrapper = shallowMount(BelongsToField, {
                stubs: ['default-field'],
                propsData: {
    ...
    test('if editing an existing resource it selects the related resource on mount if the field is not searchable',
        async () => {
            const wrapper = shallowMount(BelongsToField, {
                stubs: ['default-field'],
                propsData: {
    ...
    test('if editing an existing resource it selects the related resource on mount if the field is searchable',
        async () => {
            const wrapper = shallowMount(BelongsToField, {
                stubs: ['default-field'],
                propsData: {
