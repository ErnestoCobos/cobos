            ...
            Route::namespace('Laravel\Nova\Http\Controllers')
                ...
                ->group(function () {
                    Route::get('/password/reset',
                        'ForgotPasswordController@showLinkRequestForm')->name('nova.password.request');
                    Route::post('/password/email',
                        'ForgotPasswordController@sendResetLinkEmail')->name('nova.password.email');
                    Route::get('/password/reset/{token}',
                        'ResetPasswordController@showResetForm')->name('nova.password.reset');
        ...
        public function register()
        {
            ...
            $defineRouterControllerRoutes = function () {
                Route::middleware(config('nova.middleware', []))
                    ...
                    ->group(function () {
                        Route::get(Nova::path(),
                            'Laravel\Nova\Http\Controllers\RouterController@show')->name('nova.index');
                    });
